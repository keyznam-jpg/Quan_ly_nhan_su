...
conn = mysql.connector.connect(host='localhost', user='root', password='9999', database='quan_ly_nhan_su')
cursor = conn.cursor()

# Drop the trigger first
cursor.execute("DROP TRIGGER IF EXISTS update_tongketthang_luong")
